...
var runtimeAndLinknamed = []string{
	"arena",                         // go1.26
	"crypto/fips140",                // go1.26
	"crypto/internal/boring",        // go1.26
	"crypto/internal/boring/bcache", // go1.26
	"crypto/internal/fips140",       // go1.26
	"crypto/internal/sysrand",       // go1.26
	"crypto/rand",                   // go1.26
	"crypto/subtle",                 // go1.26
	"crypto/x509/internal/macos",    // go1.26
	"internal/bytealg",              // go1.26
	"internal/coverage/cfile",       // go1.26
	"internal/cpu",                  // go1.26
	"internal/godebug",              // go1.26
	"internal/poll",                 // go1.26
	"internal/race",                 // go1.26
	"internal/reflectlite",          // go1.26
	"internal/runtime/atomic",       // go1.26
	"internal/runtime/cgroup",       // go1.26
	"internal/runtime/maps",         // go1.26
	"internal/sync",                 // go1.26
	"internal/synctest",             // go1.26
	"internal/syscall/unix",         // go1.26
	"internal/syscall/windows",      // go1.26
	"maps",                          // go1.26
	"os",                            // go1.26
	"os/signal",                     // go1.26
	"plugin",                        // go1.26
	"reflect",                       // go1.26
	"runtime",                       // go1.26
	"runtime/debug",                 // go1.26
	"runtime/metrics",               // go1.26
	"runtime/pprof",                 // go1.26
	"runtime/secret",                // go1.26
	"runtime/trace",                 // go1.26
	"sync",                          // go1.26
	"sync/atomic",                   // go1.26
	"sync_test",                     // go1.26
	"syscall",                       // go1.26
